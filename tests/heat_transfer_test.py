...
@pytest.mark.parametrize("tts, reaSource, imgSource, approximation, M, N, expected", [
        ...
        (np.array([0.1, 1., 10.]), False, True, False, 21, 10, np.array(
            [-0.0230253, -0.14490724, -0.41781839])),
        ...
        (np.array([0.1, 1., 10.]), False, True, True, 21, 10, np.array(
            [-0.02302571, -0.14490175, -0.41776699])),
...
@pytest.mark.parametrize("tts, reaSource, imgSource, approximation, M, N, expected", [
        ...
        (np.array([0.1, 1., 10.]), False, True, False, 21, 10, np.array(
            [[[-0.02037549, -0.01111298],
              [-0.01111298, -0.02037549]],
             [[-0.12938617, -0.10593651],
              [-0.10593651, -0.12938617]],
             [[-0.38493357, -0.34716039],
              [-0.34716039, -0.38493357]]]).transpose((1, 2, 0))),
        ...
        (np.array([0.1, 1., 10.]), False, True, True, 21, 10, np.array(
            [[[-0.02037576, -0.01111366],
              [-0.01111366, -0.02037576]],
             [[-0.1293816, -0.10592953],
              [-0.10592953, -0.1293816]],
             [[-0.38489356, -0.34712584],
              [-0.34712584, -0.38489356]]]).transpose((1, 2, 0))),
