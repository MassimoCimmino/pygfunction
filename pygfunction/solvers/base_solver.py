...
class _BaseSolver(object):
    ...
    """
    def __init__(
            self, borefield: Borefield, network: Union[Network, None],
            time: npt.ArrayLike, boundary_condition: str,
            m_flow_borehole: Union[npt.ArrayLike, None] = None,
            m_flow_network: Union[npt.ArrayLike, None] = None,
            cp_f: Union[float, None] = None, nSegments: int = 8,
            segment_ratios: Union[npt.ArrayLike, List[npt.ArrayLike], Callable[[int], npt.ArrayLike]] = utilities.segment_ratios,
            approximate_FLS: bool = False, mQuad: int = 11, nFLS: int = 10,
            linear_threshold: Union[float, None] = None, disp: bool = False,
            profiles: bool = False, kind: str = 'linear',
            dtype: npt.DTypeLike = np.double, **other_options):
        # Input attributes
    ...
    def solve(self, time: npt.ArrayLike, alpha: float) -> npt.ArrayLike:
        """
